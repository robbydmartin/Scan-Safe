...
function InfluencerDashboardNavbar() {
    ...
    return (
        <nav className="navbar navbar-expand-lg px-4 navbar-light bg-light">
            <a className="navbar-brand d-flex flex-row align-items-center" href="scan.html">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-upc-scan" viewBox="0 0 16 16" style={{ transform: 'translate(-3.5px)' }} >
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                <ul className="navbar-nav me-auto mb-2 mb-lg-0 ml-auto">
                    {(() => {
                        if (Object.is(console.log(location.pathname),"InfluencerDashboard")) {
                            <li className="nav-item">
                                <a className="nav-link" href='InfluencerDashboard' aria-disabled="true">Dashboard</a>
                            </li>
                        };
                        })}
                    <li className="nav-item">
...
export default InfluencerDashboardNavbar;